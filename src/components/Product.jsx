  ...
  return (
    ...
    <div className='container product-detail'>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Premium Jackets and T-shirts</li>
        </ol>
        </nav>
        </div>
...
>
    ...
    <SwiperSlide >
      ...
      />
                ...
                <div>
                    100% Original Products <br /> Pay on delivery might be available <br /> Easy 30 days returns and exchanges 
                </div>
                ...
                <div className='add-to-cart my-4'>
                    <Link to="/cart" className='btn btn-primary text-uppercase'>Add to Cart</Link>
