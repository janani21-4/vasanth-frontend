      ...
      <div className='container'>
        <div className='row mb-5'>
          <div className='col-md-3 pb-4'>
            ...
            <div className='pt-3 pe-5'>Trendy collections crafted <br /> with comfort and quality. <br />
  Elevate your everyday style <br />with Pure Wear.</div>
          ...
          <ul>
            <li>
              <a href="#">+91-98XXXXXXXX</a>
            </li>
                 <li>
              <a href="#">info@fashion.com</a>
            </li>
          </ul>
          </div>
        ...
        <div className='row'>
          <div className='col-md-12 text-center pt-5'>
            <p >© 2024 Fashion. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </footer>
